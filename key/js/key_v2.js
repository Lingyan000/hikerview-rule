rule();
        ...
        var k365webkey =
            `海阔视界规则分享，当前分享的是：首页频道￥home_rule￥{"firstHeader":"class","title":"剧汇TV","url":"https://api.365kqzs.cn/api/programmes?limit=21&page=fypage@-1@&sort=fyyear&fyclass&location=fyarea;get;utf-8;{Device-ID@6}","col_type":"movie_3","class_name":"全部&电视剧&电影&TV动漫&动漫电影","class_url":"&category=5d2d6166eba3e50016617c92&category=5d2d616aeba3e50016617c93&category=5e23bced3204300029a2bd22&category=5e4c9f188e1f500035230080","area_name":"全部&中国大陆&中国港台&欧美&日本&韩国&印度&泰国&其他","area_url":"&中国大陆&中国港台&欧美&日本&韩国&印度&泰国&其他","year_name":"最新&最热","year_url":"new&hot","find_rule":"js: var json = {};\\r\\neval('json=' + getResCode());\\r\\nvar res = {};\\r\\nvar d = [];\\r\\nfor (var i = 0; i < json.data.programmes.length; i++) {\\r\\n    var r = {};\\r\\n    var j = json.data.programmes[i];\\r\\n    r.title = j.title;\\r\\n    if (j.episodesCount != j.resourceCount)\\r\\n        r.desc = '更新到' + j.resourceCount + '集';\\r\\n    else\\r\\n        r.desc = '全' + j.episodesCount + '集';\\r\\n    r.pic_url = j.verticalCover;\\r\\n    r.url = 'https://qingbailingyan.gitee.io/plays/play.html#https://api.365kqzs.cn/api/programmes/' + j.id;\\r\\n    if (r.title !== null && r.title !== undefined && r.title !== '') d.push(r);\\r\\n}\\r\\nres.data = d;\\r\\nsetHomeResult(res);","search_url":"https://apis.365kqzs.cn/api/programmes?limit=21&page=0&search=**&sort=new;get;utf-8;{Device-ID@8}","titleColor":"#673AB7","group":"②影搜","searchFind":"js: var json = getResCode();\\r\\nvar fires = {};\\r\\nvar resJson = {};\\r\\neval('resJson=' + json);\\r\\nvar res = [];\\r\\nif (resJson.data.programmes.length <= 0) {\\r\\n    fires.data = [];\\r\\n    setSearchResult(fires);\\r\\n} else {\\r\\n    for (var i = 0; i < resJson.data.programmes.length; i++) {\\r\\n        var mo = resJson.data.programmes[i];\\r\\n        var r = {};\\r\\n        r.title = mo.title;\\r\\n        r.url = 'https://qingbailingyan.gitee.io/plays/play.html#https://api.365kqzs.cn/api/programmes/' + mo.id;\\r\\n         if (mo.updateState == 1)\\r\\n        r.desc = '更新到' + mo.resourceCount + '集';\\r\\n    else\\r\\n        r.desc = '全' + mo.resourceCount + '集';\\r\\n        r.content = mo.summary;\\r\\n        r.img = mo.verticalCover;\\r\\n        res.push(r);\\r\\n    }\\r\\n    fires.data = res;\\r\\n    setSearchResult(fires);\\r\\n}"}`;
        var k365filekey =
            `海阔视界规则分享，当前分享的是：首页频道￥home_rule￥{"firstHeader":"class","title":"剧汇TV本地","url":"https://api.365kqzs.cn/api/programmes?limit=21&page=fypage@-1@&sort=fyyear&fyclass&location=fyarea;get;utf-8;{Device-ID@6}","col_type":"movie_3","class_name":"全部&电视剧&电影&TV动漫&动漫电影","class_url":"&category=5d2d6166eba3e50016617c92&category=5d2d616aeba3e50016617c93&category=5e23bced3204300029a2bd22&category=5e4c9f188e1f500035230080","area_name":"全部&中国大陆&中国港台&欧美&日本&韩国&印度&泰国&其他","area_url":"&中国大陆&中国港台&欧美&日本&韩国&印度&泰国&其他","year_name":"最新&最热","year_url":"new&hot","find_rule":"js: var json = {};\\r\\neval('json=' + getResCode());\\r\\nvar res = {};\\r\\nvar d = [];\\r\\nfor (var i = 0; i < json.data.programmes.length; i++) {\\r\\n    var r = {};\\r\\n    var j = json.data.programmes[i];\\r\\n    r.title = j.title;\\r\\n    if (j.episodesCount != j.resourceCount)\\r\\n        r.desc = '更新到' + j.resourceCount + '集';\\r\\n    else\\r\\n        r.desc = '全' + j.episodesCount + '集';\\r\\n    r.pic_url = j.verticalCover;\\r\\n    r.url = 'file:///sdcard/Android/data/com.example.hikerview/files/Documents/play.html#https://api.365kqzs.cn/api/programmes/' + j.id;\\r\\n    if (r.title !== null && r.title !== undefined && r.title !== '') d.push(r);\\r\\n}\\r\\nres.data = d;\\r\\nsetHomeResult(res);","search_url":"https://apis.365kqzs.cn/api/programmes?limit=21&page=0&search=**&sort=new;get;utf-8;{Device-ID@8}","titleColor":"#673AB7","group":"②影搜","searchFind":"js: var json = getResCode();\\r\\nvar fires = {};\\r\\nvar resJson = {};\\r\\neval('resJson=' + json);\\r\\nvar res = [];\\r\\nif (resJson.data.programmes.length <= 0) {\\r\\n    fires.data = [];\\r\\n    setSearchResult(fires);\\r\\n} else {\\r\\n    for (var i = 0; i < resJson.data.programmes.length; i++) {\\r\\n        var mo = resJson.data.programmes[i];\\r\\n        var r = {};\\r\\n        r.title = mo.title;\\r\\n        r.url = 'file:///sdcard/Android/data/com.example.hikerview/files/Documents/play.html#https://api.365kqzs.cn/api/programmes/' + mo.id;\\r\\n         if (mo.updateState == 1)\\r\\n        r.desc = '更新到' + mo.resourceCount + '集';\\r\\n    else\\r\\n        r.desc = '全' + mo.resourceCount + '集';\\r\\n        r.content = mo.summary;\\r\\n        r.img = mo.verticalCover;\\r\\n        res.push(r);\\r\\n    }\\r\\n    fires.data = res;\\r\\n    setSearchResult(fires);\\r\\n}"}`;
        var xxhomekey =
